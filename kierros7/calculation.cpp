...
*/
{
   ...
   cout << "Introduction: This program is a postfix calculator that uses stack to perform arithmetic operations. "
        << "The user gives command to the calculator, which work on the data in the stack "
        << "and prints results based on postfix notation. "
        << "Operators always use values stored on the stack, and results will be pushed back onto the stack at the end." << endl;
}
...
*/
{
   ...
   cout << "[a] Compute the average of all stack values." << endl;
...

{
   ...
   if (argc == 1) {
      while(closing) {
         ...
         cout << "Example demonstration by typing a sequence of text: 1 3 + 7.5 - =, result will be -3.5" << endl;
         while(cin >> input) {
